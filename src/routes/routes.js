...
const routes = [
  ...
  { path: "/recuperar-password", component: recuperarContra },
  {
    ...
    children: [
      ...
      {
        path: "/solicitar-salida/:idPedido",
        beforeEnter: auth,
        meta: { rol: ["admin"] },
        name: "Salida",
        props: true,
        component: solicitarSalida,
      },
      {
        path: "/productos",
        beforeEnter: auth,
      ...
      },
      {
        ...
        beforeEnter: auth,
        meta: { rol: ["admin", "instructor", "bodega"] },
        component: historialPedido,
      },
      {
        path: "/historial-salida",
        beforeEnter: auth,
        meta: { rol: ["admin"] },
        component: historialSalida,
      },
      {
        path: "/distribucion-dependencia/:idDependencia",
        beforeEnter: auth,
        meta: { rol: ["admin"] },
        name: "Dependencia con ID",
        component: distribucionDependencia,
        props: true,
      },
      {
        path: "/distribucion-dependencia-red",
        beforeEnter: auth,
        meta: { rol: ["admin"] },
        component: distribucionDependenciaRed,
      },
      {
        path: "/distribucion-dependencia-red/:idDistribucionDependencia",
        beforeEnter: auth,
        meta: { rol: ["admin"] },
        name: "DestinosConID",
        component: distribucionDependenciaRed,
      ...
      },
      {
        ...
        beforeEnter: auth,
        meta: { rol: ["admin"] },
        component: redConocimiento,
      },
      {
        path: "/conexion-red-lote/:conexion/:id",
        beforeEnter: auth,
        meta: { rol: ["admin"] },
        props: true,
        component: conexionRedLote,
      },
      {
        path: "/editar-perfil",
        beforeEnter: auth,
