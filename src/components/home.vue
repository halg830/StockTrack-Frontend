...
<template>
    <div class="main">
        ...
        <div class="section">
            <q-btn class="btn-administrar" color="green-7" text-color="white" :label="rol=='admin' ? 'Administrar' : 'Generar pedido'" :to="rol=='admin' ? '/fichas' : '/solicitar-pedido'"/>
...
.btn-administrar:hover{
    box-shadow: 2px 2px 2px 2px #4c7c26;
}
</style>