...
<template>
    <main style=" width: 100%; display: flex; justify-content: center;">
        ...
        <q-table :rows="rows" :columns="columns" row-key="name" :loading="loadingTable" loading-label="Cargando..."
            ...
            wrap-cells="false" label="Lotes" style="width: 90%;" no-data-label="No hay Lotes registrados.">
            <template v-slot:top-left>
                <div style=" display: flex; gap: 10px;">
                    <h4 id="titleTable">Red de conocimiento </h4>
            ...
            <template v-slot:body-cell-opciones="props">
                <q-td :props="props" class="botones">
                    <div id="buttons">
                        ...
                        <button class="btn-go" @click="goConexRedLote(props.row._id)">Conexion Red-Lote <i
