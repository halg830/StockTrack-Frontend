...
const columns = [
  { name: "nombre producto", label: "nombre producto", field: val => val.idProducto.nombre, sortable: true, align: "center" },
    ...
    <q-dialog v-model="modal">
      <q-card class="modal" style="width: 450px;">
        <q-toolbar style="background-color: #39A900;color: white">
          <q-toolbar-title>{{ helpersGenerales.primeraMayus(estado) }} entrada</q-toolbar-title>
