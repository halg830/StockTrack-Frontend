...
const columns = [
    { name: "presupuesto", label: "Presupuesto", field: "presupuestoAsignado", sortable: true, align: "left" },
    { name: "presupuestoDisponible", label: "Presupuesto Disponible", field: "presupuestoDisponible", sortable: true, align: "left" },
    { name: "idContrato", label: "Contrato Nombre", field: (row) => row.idDistribucionPresupuesto.idLote.nombre, align: "left" },
    { name: "idLote", label: "Lote Nombre", field: (row) => row.idDistribucionPresupuesto.idItem.nombre, align: "left" },
...
<template>
    <main style=" width: 100%; display: flex; justify-content: center; flex-direction: column; align-items: center;">
        ...
        <q-table :rows="rows" :columns="columns" row-key="name" :loading="loadingTable" loading-label="Cargando..."
            ...
            no-results-label="No hay resultados para la búsqueda." wrap-cells="false" label="Distribución Contrato Lote" style="width: 90%;"
            no-data-label="No hay Distribución Contrato Lote registrados.">
            <template v-slot:top-left>
                <div style=" display: flex; gap: 10px;">
                    <h4 id="titleTable">Distribución Contrato Lote</h4>
